...
Studentas::Studentas(const Studentas& other)
    ...
    ndPazymiai(other.ndPazymiai), egzaminas(other.egzaminas), galutinis(other.galutinis) {
}

Studentas::Studentas(Studentas&& other) noexcept
    : vardas(std::move(other.vardas)), pavarde(std::move(other.pavarde)),
    ndPazymiai(std::move(other.ndPazymiai)), egzaminas(other.egzaminas), galutinis(other.galutinis) {
}
